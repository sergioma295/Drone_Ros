...
if("FALSE" STREQUAL "TRUE")
  set(python_qt_binding_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-python-qt-binding-0.3.4)
  set(python_qt_binding_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-python-qt-binding-0.3.4/obj-x86_64-linux-gnu/devel)
  ...
  set(python_qt_binding_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'python_qt_binding' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
