...
(defsystem "control_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "JointJog" :depends-on ("_package_JointJog"))
    (:file "_package_JointJog" :depends-on ("_package"))
    ...
    (:file "PidState" :depends-on ("_package_PidState"))
    (:file "_package_PidState" :depends-on ("_package"))
