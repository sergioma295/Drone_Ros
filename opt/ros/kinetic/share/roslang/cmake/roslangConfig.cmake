...
if("FALSE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-roslang-1.14.4)
  set(roslang_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-roslang-1.14.4/obj-x86_64-linux-gnu/devel)
  set(roslang_INSTALL_PREFIX "")
  set(roslang_PREFIX ${roslang_DEVEL_PREFIX})
else()
  set(roslang_SOURCE_PREFIX "")
  set(roslang_DEVEL_PREFIX "")
  set(roslang_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
