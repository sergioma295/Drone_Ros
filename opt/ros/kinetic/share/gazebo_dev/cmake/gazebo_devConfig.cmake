...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-dev-2.5.18)
  set(gazebo_dev_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-dev-2.5.18/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_dev_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
