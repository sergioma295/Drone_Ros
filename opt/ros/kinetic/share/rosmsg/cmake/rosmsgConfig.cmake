...
if("FALSE" STREQUAL "TRUE")
  set(rosmsg_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosmsg-1.12.14)
  set(rosmsg_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosmsg-1.12.14/obj-x86_64-linux-gnu/devel)
  set(rosmsg_INSTALL_PREFIX "")
  set(rosmsg_PREFIX ${rosmsg_DEVEL_PREFIX})
else()
  set(rosmsg_SOURCE_PREFIX "")
  set(rosmsg_DEVEL_PREFIX "")
  set(rosmsg_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmsg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
