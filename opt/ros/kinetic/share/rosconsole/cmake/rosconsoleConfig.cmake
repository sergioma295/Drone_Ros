...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-1.12.14)
  set(rosconsole_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-1.12.14/obj-x86_64-linux-gnu/devel)
  ...
  set(rosconsole_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
