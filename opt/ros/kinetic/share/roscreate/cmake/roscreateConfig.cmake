...
if("FALSE" STREQUAL "TRUE")
  set(roscreate_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-roscreate-1.14.4)
  set(roscreate_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-roscreate-1.14.4/obj-x86_64-linux-gnu/devel)
  ...
  set(roscreate_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/roscreate " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/roscreate' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
