...
if("FALSE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gmapping-1.3.10)
  set(gmapping_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gmapping-1.3.10/obj-x86_64-linux-gnu/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
