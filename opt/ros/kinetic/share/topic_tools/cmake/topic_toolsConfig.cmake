...
if("FALSE" STREQUAL "TRUE")
  set(topic_tools_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-topic-tools-1.12.14)
  set(topic_tools_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-topic-tools-1.12.14/obj-x86_64-linux-gnu/devel)
  ...
  set(topic_tools_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
