...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-pluginlib-1.11.3)
  set(pluginlib_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-pluginlib-1.11.3/obj-x86_64-linux-gnu/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
