...
if("FALSE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-image-geometry-1.12.8)
  set(image_geometry_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-image-geometry-1.12.8/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
