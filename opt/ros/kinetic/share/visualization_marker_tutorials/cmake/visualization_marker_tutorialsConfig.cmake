...
if("FALSE" STREQUAL "TRUE")
  set(visualization_marker_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-visualization-marker-tutorials-0.10.3)
  set(visualization_marker_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-visualization-marker-tutorials-0.10.3/obj-x86_64-linux-gnu/devel)
  ...
  set(visualization_marker_tutorials_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visualization_marker_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
