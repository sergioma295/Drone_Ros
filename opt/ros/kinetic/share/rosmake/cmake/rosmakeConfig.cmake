...
if("FALSE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosmake-1.14.4)
  set(rosmake_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosmake-1.14.4/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
