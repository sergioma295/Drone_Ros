...
if("FALSE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-openslam-gmapping-0.1.2)
  set(openslam_gmapping_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-openslam-gmapping-0.1.2/obj-x86_64-linux-gnu/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
