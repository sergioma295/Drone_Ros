...
if("FALSE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-tf2-ros-0.5.20)
  set(tf2_ros_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-tf2-ros-0.5.20/obj-x86_64-linux-gnu/devel)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
