...
if("FALSE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rostest-1.12.14)
  set(rostest_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rostest-1.12.14/obj-x86_64-linux-gnu/devel)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
