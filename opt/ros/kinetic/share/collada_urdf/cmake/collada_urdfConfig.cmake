...
if("FALSE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-collada-urdf-1.12.12)
  set(collada_urdf_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-collada-urdf-1.12.12/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include/assimp;/usr/include/collada-dom2.4/1.5;/usr/include/collada-dom2.4;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
