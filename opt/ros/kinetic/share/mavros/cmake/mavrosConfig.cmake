...
if("FALSE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-mavros-0.29.2)
  set(mavros_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-mavros-0.29.2/obj-x86_64-linux-gnu/devel)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
