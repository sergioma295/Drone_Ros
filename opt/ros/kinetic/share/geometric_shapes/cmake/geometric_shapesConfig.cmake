...
if("FALSE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-geometric-shapes-0.5.4)
  set(geometric_shapes_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-geometric-shapes-0.5.4/obj-x86_64-linux-gnu/devel)
  ...
  set(geometric_shapes_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/geometric_shapes " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Dave Coleman <dave@dav.ee>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(geometric_shapes_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "geometric_shapes;/opt/ros/kinetic/lib/liboctomap.so;/opt/ros/kinetic/lib/liboctomath.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
