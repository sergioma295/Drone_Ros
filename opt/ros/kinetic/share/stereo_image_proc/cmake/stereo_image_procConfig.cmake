...
if("FALSE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-stereo-image-proc-1.12.23)
  set(stereo_image_proc_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-stereo-image-proc-1.12.23/obj-x86_64-linux-gnu/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
