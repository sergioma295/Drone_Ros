...
if("FALSE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosnode-1.12.14)
  set(rosnode_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosnode-1.12.14/obj-x86_64-linux-gnu/devel)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
