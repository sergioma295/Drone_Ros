...
if("FALSE" STREQUAL "TRUE")
  set(rosboost_cfg_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosboost-cfg-1.14.4)
  set(rosboost_cfg_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosboost-cfg-1.14.4/obj-x86_64-linux-gnu/devel)
  ...
  set(rosboost_cfg_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosboost_cfg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
