...
if("FALSE" STREQUAL "TRUE")
  set(rostopic_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rostopic-1.12.14)
  set(rostopic_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rostopic-1.12.14/obj-x86_64-linux-gnu/devel)
  set(rostopic_INSTALL_PREFIX "")
  set(rostopic_PREFIX ${rostopic_DEVEL_PREFIX})
else()
  set(rostopic_SOURCE_PREFIX "")
  set(rostopic_DEVEL_PREFIX "")
  set(rostopic_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
