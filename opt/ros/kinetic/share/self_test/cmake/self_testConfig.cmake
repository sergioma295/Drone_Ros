...
if("FALSE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-self-test-1.9.3)
  set(self_test_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-self-test-1.9.3/obj-x86_64-linux-gnu/devel)
  ...
  set(self_test_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
