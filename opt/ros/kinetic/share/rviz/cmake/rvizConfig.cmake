...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rviz-1.12.17)
  set(rviz_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rviz-1.12.17/obj-x86_64-linux-gnu/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/rviz " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/rviz' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'D. Hood <dhood@osrfoundation.org>, William Woodall <william@osrfoundation.org>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;/usr/lib/x86_64-linux-gnu/libOgreOverlay.so;/usr/lib/x86_64-linux-gnu/libOgreMain.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libGLU.so;/usr/lib/x86_64-linux-gnu/libGL.so")
...
set(depends "geometry_msgs;image_transport;interactive_markers;laser_geometry;map_msgs;message_filters;nav_msgs;pluginlib;resource_retriever;roscpp;roslib;sensor_msgs;std_msgs;tf;urdf;visualization_msgs")
foreach(depend ${depends})
  ...
  list(APPEND rviz_EXPORTED_TARGETS ${${rviz_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "rviz-extras.cmake")
