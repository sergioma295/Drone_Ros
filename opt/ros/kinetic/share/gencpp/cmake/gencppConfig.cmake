...
if("FALSE" STREQUAL "TRUE")
  set(gencpp_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gencpp-0.6.0)
  set(gencpp_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gencpp-0.6.0/obj-x86_64-linux-gnu/devel)
  set(gencpp_INSTALL_PREFIX "")
  set(gencpp_PREFIX ${gencpp_DEVEL_PREFIX})
else()
  set(gencpp_SOURCE_PREFIX "")
  set(gencpp_DEVEL_PREFIX "")
  set(gencpp_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gencpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
