...
if("FALSE" STREQUAL "TRUE")
  set(actionlib_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-actionlib-1.11.13)
  set(actionlib_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-actionlib-1.11.13/obj-x86_64-linux-gnu/devel)
  ...
  set(actionlib_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(actionlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "actionlib;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
