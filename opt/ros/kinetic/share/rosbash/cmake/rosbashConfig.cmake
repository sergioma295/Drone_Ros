...
if("FALSE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosbash-1.14.4)
  set(rosbash_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosbash-1.14.4/obj-x86_64-linux-gnu/devel)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
