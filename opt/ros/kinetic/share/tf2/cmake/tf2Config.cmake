...
if("FALSE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-tf2-0.5.20)
  set(tf2_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-tf2-0.5.20/obj-x86_64-linux-gnu/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
