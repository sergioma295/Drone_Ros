...
if("FALSE" STREQUAL "TRUE")
  set(compressed_depth_image_transport_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-compressed-depth-image-transport-1.9.5)
  set(compressed_depth_image_transport_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-compressed-depth-image-transport-1.9.5/obj-x86_64-linux-gnu/devel)
  ...
  set(compressed_depth_image_transport_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
