...
if("FALSE" STREQUAL "TRUE")
  set(rqt_image_view_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rqt-image-view-0.4.13)
  set(rqt_image_view_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rqt-image-view-0.4.13/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_image_view_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_image_view' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
