...
if("FALSE" STREQUAL "TRUE")
  set(kdl_parser_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-kdl-parser-1.12.11)
  set(kdl_parser_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-kdl-parser-1.12.11/obj-x86_64-linux-gnu/devel)
  ...
  set(kdl_parser_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(kdl_parser_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "kdl_parser;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.0;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
