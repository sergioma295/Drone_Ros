...
if("FALSE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosbag-1.12.14)
  set(rosbag_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosbag-1.12.14/obj-x86_64-linux-gnu/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
