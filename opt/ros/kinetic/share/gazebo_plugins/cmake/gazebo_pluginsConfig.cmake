...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-plugins-2.5.18)
  set(gazebo_plugins_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-plugins-2.5.18/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
