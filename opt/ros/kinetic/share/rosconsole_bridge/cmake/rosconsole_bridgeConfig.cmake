...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_bridge_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-bridge-0.5.2)
  set(rosconsole_bridge_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-bridge-0.5.2/obj-x86_64-linux-gnu/devel)
  ...
  set(rosconsole_bridge_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosconsole_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole_bridge;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
