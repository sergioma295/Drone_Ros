...
if("FALSE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-stereo-msgs-1.12.7)
  set(stereo_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-stereo-msgs-1.12.7/obj-x86_64-linux-gnu/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
