...
if("FALSE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-image-publisher-1.12.23)
  set(image_publisher_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-image-publisher-1.12.23/obj-x86_64-linux-gnu/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
