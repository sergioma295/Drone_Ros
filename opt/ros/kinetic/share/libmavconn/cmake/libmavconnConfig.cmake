...
if("FALSE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-libmavconn-0.29.2)
  set(libmavconn_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-libmavconn-0.29.2/obj-x86_64-linux-gnu/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
