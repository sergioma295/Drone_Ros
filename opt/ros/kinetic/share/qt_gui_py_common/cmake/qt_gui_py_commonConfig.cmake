...
if("FALSE" STREQUAL "TRUE")
  set(qt_gui_py_common_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-qt-gui-py-common-0.3.11)
  set(qt_gui_py_common_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-qt-gui-py-common-0.3.11/obj-x86_64-linux-gnu/devel)
  ...
  set(qt_gui_py_common_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/qt_gui_py_common " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'D. Hood <dhood@osrfoundation.org>, Dorian Scholz <scholz@sim.tu-darmstadt.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qt_gui_py_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
